    ...
    : QDialog(parent) 
{
    ...
    actionKeys << tr("Double") << tr("Space") << tr("Tab") << tr("Backspace") << tr("Enter") << tr("Esc") << tr("Home") << 
    ...
    iActionKeys << Qt::Key_F16 << Qt::Key_Space << Qt::Key_Tab << Qt::Key_Backspace << Qt::Key_Enter << Qt::Key_Escape << Qt::Key_Home <<
    ...
    QKeySequence keys = gSettings->value("Options/hotkey", QKeySequence(Qt::ControlModifier +  Qt::Key_F16)).value<QKeySequence>();
    #ifdef Q_WS_WIN
...
void OptionsDlg::accept() {
	...
	if ( iMetaKeys[genModifierBox->currentIndex()] == Qt::MetaModifier  &&
